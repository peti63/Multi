...
#	define INTRUSIVE_HANDSHAKE_LOG TRUE
...
class DESC
{
	...
	public:
...
#endif
		void SendHWIDStatusPacket(BYTE bStatus, BYTE bValid1, BYTE bValid2, BYTE bValid3, BYTE bValid4, BYTE bValid5);
		...
		void			SetTester(bool bFlag) { m_accountTable.isTester = bFlag; }
		bool			IsTester() { return m_accountTable.isTester; }
#endif
